...
import { A as AstroError, i as InvalidImageService, j as ExpectedImageOptions, E as ExpectedImage, k as FailedToFetchRemoteImageDimensions, c as createAstro, d as createComponent, l as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, e as addAttribute, s as spreadAttributes } from '../astro_BjFoP488.mjs';
import { r as resolveSrc, i as isRemoteImage, a as isESMImportedImage, b as isLocalService, D as DEFAULT_HASH_PROPS, c as isRemoteAllowed } from '../astro/assets-service_ICMEYo2w.mjs';
import 'html-escaper';
import 'clsx';
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_ICMEYo2w.mjs'
    ).then(n => n.s).catch((e) => {
